...
var app = (function () {
    ...
    const touches = writable([{x: 0, y: 0, wet: 0},
                                     {x: 0, y: 0, wet: 0},
                                     {x: 0, y: 0, wet: 0},
                                     {x: 0, y: 0, wet: 0},
                                     {x: 0, y: 0, wet: 0}]);
    ...
    function create_fragment(ctx) {
    	var ion_content, canvas0, t, canvas1, dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			dispose = [
    				...
    				listen_dev(canvas0, "touchmove", prevent_default(ctx.updateTouchPositions), false, true),
    				listen_dev(canvas0, "touchend", prevent_default(ctx.touchend_handler), false, true)
    			];
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_content, canvas0);
    			ctx.canvas0_binding(canvas0);
    			append_dev(ion_content, t);
    			append_dev(ion_content, canvas1);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      onMount(() => {
    	...
    	const touchstart_handler = (event) => setTouchDryWet(1, event);

    	const touchend_handler = (event) => setTouchDryWet(0, event);

    	function canvas1_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('copy', copy = $$value);
    		});
    	}
    ...
    class InstrumentTab extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, []);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "InstrumentTab", options, id: create_fragment.name });
    	}
    }

    /* src\AudioEffect.svelte generated by Svelte v3.12.0 */

    const file$1 = "src\\AudioEffect.svelte";

    function create_fragment$1(ctx) {
    	var ion_reorder, ion_item_sliding, ion_item, div, ion_button, t0, t1, ion_item_options, ion_item_option, ion_icon, dispose;

    	const block = {
    		c: function create() {
    			ion_reorder = element("ion-reorder");
    		...
    		m: function mount(target, anchor) {
    			insert_dev(target, ion_reorder, anchor);
    			append_dev(ion_reorder, ion_item_sliding);
    			append_dev(ion_item_sliding, ion_item);
    			append_dev(ion_item, div);
    			append_dev(div, ion_button);
    			append_dev(ion_button, t0);
    			ctx.ion_button_binding(ion_button);
    			append_dev(ion_item_sliding, t1);
    			append_dev(ion_item_sliding, ion_item_options);
    			append_dev(ion_item_options, ion_item_option);
    			append_dev(ion_item_option, ion_icon);
    			ctx.ion_item_sliding_binding(ion_item_sliding);
    		},
    		...
    		d: function destroy(detaching) {
    			if (detaching) {
    				detach_dev(ion_reorder);
    			}

    			ctx.ion_button_binding(null);
    			ctx.ion_item_sliding_binding(null);
    			dispose();
    		}
    	};
    ...
    function instance$1($$self, $$props, $$invalidate) {
      ...
      let { name, effect, index, shrink = false, reorder = false } = $$props;
      ...
      onMount(() => {
    	...
    	const writable_props = ['name', 'effect', 'index', 'shrink', 'reorder'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<AudioEffect> was created with unknown prop '${key}'`);
    	});

    	function ion_button_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('button', button = $$value);
    		});
    	}

    	const ionSwipe_handler = () => $$invalidate('shrink', shrink = true);

    	function ion_item_sliding_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('ionItemSliding', ionItemSliding = $$value);
    		});
    	}

    	$$self.$set = $$props => {
    		if ('name' in $$props) $$invalidate('name', name = $$props.name);
    		if ('effect' in $$props) $$invalidate('effect', effect = $$props.effect);
    		if ('index' in $$props) $$invalidate('index', index = $$props.index);
    		if ('shrink' in $$props) $$invalidate('shrink', shrink = $$props.shrink);
    		if ('reorder' in $$props) $$invalidate('reorder', reorder = $$props.reorder);
    	};

    	$$self.$capture_state = () => {
    		return { name, effect, index, shrink, reorder, xParam, yParam, ionItemSliding, swipe, button, x, $touches, y };
    	};
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('shrink' in $$props) $$invalidate('shrink', shrink = $$props.shrink);
    		if ('reorder' in $$props) $$invalidate('reorder', reorder = $$props.reorder);
    		if ('xParam' in $$props) $$invalidate('xParam', xParam = $$props.xParam);
    		if ('yParam' in $$props) $$invalidate('yParam', yParam = $$props.yParam);
    		if ('ionItemSliding' in $$props) $$invalidate('ionItemSliding', ionItemSliding = $$props.ionItemSliding);
    		if ('swipe' in $$props) $$invalidate('swipe', swipe = $$props.swipe);
    	...
    	$$self.$$.update = ($$dirty = { name: 1, $touches: 1, index: 1, xParam: 1, x: 1, yParam: 1, y: 1, effect: 1, shrink: 1, ionItemSliding: 1 }) => {
    		if ($$dirty.name || $$dirty.$touches || $$dirty.index) { $$invalidate('x', x = effectParams[name].xScale($touches[index].x)); }
    		if ($$dirty.name || $$dirty.$touches || $$dirty.index) { $$invalidate('y', y = effectParams[name].yScale($touches[index].y)); }
    		if ($$dirty.xParam || $$dirty.x) { xParam.rampTo(x); }
    		if ($$dirty.yParam || $$dirty.y) { yParam.rampTo(y); }
    		if ($$dirty.effect || $$dirty.$touches || $$dirty.index) { effect.wet.rampTo($touches[index].wet, 0.01); }
    		if ($$dirty.shrink || $$dirty.ionItemSliding) { if(shrink) {
            $$invalidate('swipe', swipe = true);
            setTimeout( () => dispatch('remove'), 500);
            ionItemSliding.closeOpened();
          } else {
            $$invalidate('swipe', swipe = false);
          } }
    	};
    	...
    	return {
    		...
    		ion_button_binding,
    		ionSwipe_handler,
    		ion_item_sliding_binding
    	};
    }

    class AudioEffect extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, ["name", "effect", "index", "shrink", "reorder"]);
    		dispatch_dev("SvelteRegisterComponent", { component: this, tagName: "AudioEffect", options, id: create_fragment$1.name });

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.name === undefined && !('name' in props)) {
    			console.warn("<AudioEffect> was created without expected prop 'name'");
    		}
    		if (ctx.effect === undefined && !('effect' in props)) {
    			console.warn("<AudioEffect> was created without expected prop 'effect'");
    		}
    		if (ctx.index === undefined && !('index' in props)) {
    			console.warn("<AudioEffect> was created without expected prop 'index'");
    		}
    	}

    	get name() {
    		throw new Error("<AudioEffect>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set name(value) {
    		throw new Error("<AudioEffect>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    ...
    function create_each_block(ctx) {
    	...
    	function remove_handler() {
    		return ctx.remove_handler(ctx);
    	}

    	let audioeffect_props = {};
    	for (var i_1 = 0; i_1 < audioeffect_spread_levels.length; i_1 += 1) {
    		audioeffect_props = assign(audioeffect_props, audioeffect_spread_levels[i_1]);
    	}
    	var audioeffect = new AudioEffect({ props: audioeffect_props, $$inline: true });
    	audioeffect.$on("remove", remove_handler);

    	const block = {
    		c: function create() {
    			audioeffect.$$.fragment.c();
    		},

    		m: function mount(target, anchor) {
    			mount_component(audioeffect, target, anchor);
    			current = true;
    		},

    		p: function update(changed, new_ctx) {
    			ctx = new_ctx;
    			var audioeffect_changes = (changed.effects || changed.reorder) ? get_spread_update(audioeffect_spread_levels, [
    									(changed.effects) && get_spread_object(ctx.effect),
    			audioeffect_spread_levels[1],
    			(changed.reorder) && { reorder: ctx.reorder }
    								]) : {};
    			audioeffect.$set(audioeffect_changes);
    		},

    		i: function intro(local) {
    			if (current) return;
    			transition_in(audioeffect.$$.fragment, local);

    			current = true;
    		},

    		o: function outro(local) {
    			transition_out(audioeffect.$$.fragment, local);
    			current = false;
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div = element("div");
    			ion_reorder_group = element("ion-reorder-group");
    		...
    		m: function mount(target, anchor) {
    			...
    			for (let i = 0; i < each_blocks.length; i += 1) {
    				each_blocks[i].m(ion_reorder_group, null);
    			}
    		...
    		p: function update(changed, ctx) {
    			...
    			if ((!current || changed.reorder) && ion_reorder_group_disabled_value !== (ion_reorder_group_disabled_value = !ctx.reorder)) {
    				set_custom_element_data(ion_reorder_group, "disabled", ion_reorder_group_disabled_value);
    			}
    ...
    function instance$2($$self, $$props, $$invalidate) {
      ...
      const availableEffects = {
        ...
        {
          symbol: 'Delay',
          getEffect: function() {return new Tone$1.FeedbackDelay ();}
        },
        reverb:
        {
          symbol: 'Reverb',
          getEffect: function() {return new Tone$1.Freeverb();}
        },
        tremelo:
        {
          symbol: 'Tremelo',
          getEffect: function() {return new Tone$1.Tremolo ();}
        },
        vibrato:
        {
          getEffect: function() {return new Tone$1.Vibrato ();}
        }
      };


      let { maxEffects = 5 } = $$props;
      ...
      const mic = new Tone$1.UserMedia();
      mic.open();
      ...
      function addNewEffect(effect) {
    	...
    	const remove_handler = ({ effect }) => removeEffect(effect);

    	const ionItemReorder_handler = ({detail}) => $$invalidate('effects', effects = detail.complete(effects));

    	function ion_action_sheet_controller_binding($$value) {
    		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
    			$$invalidate('controller', controller = $$value);
    		});
    	}

    	$$self.$set = $$props => {
    		if ('maxEffects' in $$props) $$invalidate('maxEffects', maxEffects = $$props.maxEffects);
    	};

    	$$self.$capture_state = () => {
    		return { maxEffects, effects, reorder, controller, fabButton };
    	};

    	$$self.$inject_state = $$props => {
    		if ('maxEffects' in $$props) $$invalidate('maxEffects', maxEffects = $$props.maxEffects);
    		if ('effects' in $$props) $$invalidate('effects', effects = $$props.effects);
    		if ('reorder' in $$props) $$invalidate('reorder', reorder = $$props.reorder);
    		if ('controller' in $$props) $$invalidate('controller', controller = $$props.controller);
    		if ('fabButton' in $$props) $$invalidate('fabButton', fabButton = $$props.fabButton);
    	};

    	let fabButton;

    	$$self.$$.update = ($$dirty = { effects: 1, maxEffects: 1 }) => {
    	...
    	return {
    		...
    		click_handler,
    		remove_handler,
    		ionItemReorder_handler,
    		ion_action_sheet_controller_binding
    	};
    }
    ...
    class EffectsTab extends SvelteComponentDev {
    	...
    	get maxEffects() {
    		throw new Error("<EffectsTab>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set maxEffects(value) {
    		throw new Error("<EffectsTab>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			ion_tab0 = element("ion-tab");
    			instrumenttab.$$.fragment.c();
    			t1 = space();
    			ion_tab1 = element("ion-tab");
    			effectstab.$$.fragment.c();
    			t2 = space();
    			...
    			dispose = [
    				...
    				listen_dev(window, "touchend", startContext, { once: true }),
    				listen_dev(window, "click", startContext, { once: true })
    			];
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(ion_app, ion_tabs);
    			append_dev(ion_tabs, ion_tab0);
    			mount_component(instrumenttab, ion_tab0, null);
    			append_dev(ion_tabs, t1);
    			append_dev(ion_tabs, ion_tab1);
    			mount_component(effectstab, ion_tab1, null);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(instrumenttab.$$.fragment, local);

    			transition_in(effectstab.$$.fragment, local);

    			current = true;
    		},

    		o: function outro(local) {
    			transition_out(instrumenttab.$$.fragment, local);
    			transition_out(effectstab.$$.fragment, local);
    			current = false;
    		},
    		...
    		d: function destroy(detaching) {
    			...
    			destroy_component(instrumenttab);

    			destroy_component(effectstab);
